...
export default function RegisterPage() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      setMessage({message:'Registration failed!',type:'error'});
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <button onClick={handleRegister} className="inline-block rounded bg-indigo-600 px-5 py-3 text-sm font-medium text-white">
              Sign up
            </button>
          </div>
        </form>
